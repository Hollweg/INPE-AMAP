//*******************            Manipulacao de Arquivos para Clima Espacial           *******************//
...
short int num_error = 0, counter = 0;
...
Ĩnicio_Transcricao_Dados:
    ...
    do{
        ...
        if (ne > 0)
            fprintf(output,"%f %f %f %f \n", (cos(lon)*cos(lat))*(6370000+alt) ,(sin(lon)*cos(lat))*(6370000+alt), sin(lat)*(6370000+alt), ne);
                                                                                                                                                                                                                                                                                                              //plotados no arquivo na forma x,y,z e NE
    }while (!feof(input));
...
begin:
    ...
    printf ("Coloque os arquivos que sao de origem dentro da pasta InFiles \n");
